...
class TestAbsurdWorker:
    async def test_spawned_agent_task_completes_against_postgres(self, absurd_client: AsyncAbsurd) -> None:
    ...
    async def test_worker_retry_replays_postgres_checkpoints(self, absurd_client: AsyncAbsurd) -> None:
