...
class TestIsInteractiveCommand:
    ...
    async def test_leading_spaces(self, sandbox: Sandbox) -> None:
        assert _is_interactive_command('  vi file.txt') is True
...
@pytest.fixture
def toolset(shell_dir: Path, sandbox: Sandbox) -> ShellToolset[None]:
    return ShellToolset(
        cwd=shell_dir,
        allowed_commands=[],
...
@pytest.fixture
def persist_toolset(shell_dir: Path, sandbox: Sandbox) -> ShellToolset[None]:
    return ShellToolset(
        cwd=shell_dir,
        allowed_commands=[],
        denied_commands=[],
...
class TestCommandValidation:
    ...
    async def test_allowed_command_permitted(self, shell_dir: Path, sandbox: Sandbox) -> None:
        ts = ShellToolset(
            cwd=shell_dir,
    ...
    async def test_allowed_blocks_non_matching(self, shell_dir: Path, sandbox: Sandbox) -> None:
        ts = ShellToolset(
            cwd=shell_dir,
    ...
    async def test_both_allow_and_deny_raises(self, shell_dir: Path, sandbox: Sandbox) -> None:
    ...
    async def test_interactive_allowed_when_enabled(self, shell_dir: Path, sandbox: Sandbox) -> None:
        ts = ShellToolset(
            cwd=shell_dir,
            allowed_commands=[],
            denied_commands=[],
    ...
    async def test_denied_operator_blocked(self, shell_dir: Path, sandbox: Sandbox) -> None:
        ts = ShellToolset(
            cwd=shell_dir,
            allowed_commands=[],
            denied_commands=[],
    ...
    async def test_denied_operator_passes_when_not_present(self, shell_dir: Path, sandbox: Sandbox) -> None:
        ts = ShellToolset(
            cwd=shell_dir,
            allowed_commands=[],
            denied_commands=[],
    ...
    async def test_denied_operator_substring_match(self, shell_dir: Path, sandbox: Sandbox) -> None:
        ts = ShellToolset(
            cwd=shell_dir,
            allowed_commands=[],
            denied_commands=[],
    ...
    async def test_shlex_error_returns_early(self, shell_dir: Path, sandbox: Sandbox) -> None:
        ts = ShellToolset(
            cwd=shell_dir,
            allowed_commands=[],
            denied_commands=['rm'],
    ...
    async def test_empty_tokens(self, shell_dir: Path, sandbox: Sandbox) -> None:
        ts = ShellToolset(
            cwd=shell_dir,
            allowed_commands=['echo'],
            denied_commands=[],
    ...
    async def test_first_denied_operator_match(self, toolset: ShellToolset[None], sandbox: Sandbox) -> None:
        ts = ShellToolset(
            cwd=Path('/tmp'),
            allowed_commands=[],
            denied_commands=[],
    ...
    async def test_first_denied_operator_no_match(self, toolset: ShellToolset[None], sandbox: Sandbox) -> None:
        ts = ShellToolset(
            cwd=Path('/tmp'),
            allowed_commands=[],
            denied_commands=[],
...
# class TestCwdCapture removed: tested internals dropped by sandbox migration
...
class TestRunCommand:
    ...
    async def test_persist_cwd(self, shell_dir: Path, sandbox: Sandbox) -> None:
        ts = ShellToolset(
            cwd=shell_dir,
            allowed_commands=[],
            denied_commands=[],
    ...
    async def test_non_positive_max_output_chars_rejected(self, shell_dir: Path, sandbox: Sandbox) -> None:
...
class TestProcessGroupKill:
    async def test_timeout_kills_subprocess_tree(self, shell_dir: Path, sandbox: Sandbox) -> None:
...
# class TestBackgroundCommands removed: tested internals dropped by sandbox migration
...
class TestEdgeCases:
    ...
    async def test_run_command_uses_actual_cwd(self, shell_dir: Path, sandbox: Sandbox) -> None:
        ts = ShellToolset(
            cwd=shell_dir,
            allowed_commands=[],
            denied_commands=[],
...
# class TestKillProcessGroupEdgeCases removed: tested internals dropped by sandbox migration


# class TestDrainWithTimeoutEdgeCases removed: internal method dropped
...
class TestResolveEnv:
    ...
    async def test_pattern_match_is_case_sensitive(self, shell_dir: Path, sandbox: Sandbox) -> None:
