...
| **Reliability** | **Durable execution on AWS Lambda** | Checkpoint model requests and tool calls into [AWS Lambda durable functions](https://docs.aws.amazon.com/lambda/latest/dg/durable-functions.html) steps, so a resumed execution continues from the last completed step | :white_check_mark: [Docs](pydantic_ai_harness/aws_lambda/) | |
| | **Stuck loop detection** | Detect and break out of repetitive agent loops | :construction: [PR&nbsp;#336](https://github.com/pydantic/pydantic-ai-harness/pull/336) | [pydantic-deep](https://github.com/vstorm-co/pydantic-deepagents) (vstorm&#8209;co) |
