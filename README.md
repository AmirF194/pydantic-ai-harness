...
| | **Conversation archive** | Archive the full message history before compaction and recall it with a dependency-free BM25 `search_conversation_history` tool | :white_check_mark: [Docs](pydantic_ai_harness/conversation_archive/) | [pydantic-deep](https://github.com/vstorm-co/pydantic-deepagents) (vstorm&#8209;co) |
