...
| | **Durable execution** | Checkpoint an agent's model, MCP, and tool I/O into [Absurd](https://github.com/earendil-works/absurd) steps so a crashed worker resumes mid-run | :white_check_mark: [Docs](pydantic_ai_harness/absurd/) | |
