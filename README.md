...
uv add "pydantic-ai-harness[browser]"           # Browser (real Chromium via Playwright; run `playwright install chromium`)
...
| | **Browser** | Real, stateful Chromium via [Playwright](https://playwright.dev/python/) -- navigate, click, type, scroll, extract text, run JS, and screenshot JS-heavy or authenticated pages | :white_check_mark: [Docs](pydantic_ai_harness/browser/) | [pydantic-deep](https://github.com/vstorm-co/pydantic-deepagents) (vstorm&#8209;co) |
