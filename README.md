...
| | **Cost/token budgets** | Enforce spend and token ceilings over a run, a day, or a month, shared across processes | :white_check_mark: [Docs](pydantic_ai_harness/spend/) | [pydantic-ai-shields](https://github.com/vstorm-co/pydantic-ai-shields) (vstorm&#8209;co) |
