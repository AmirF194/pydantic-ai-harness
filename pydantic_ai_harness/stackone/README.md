...
1. [Configure a connector and link an account](https://docs.stackone.com/guides/introduction). For your first test,
   enable only the read actions you need.
2. [Copy the linked account ID](https://docs.stackone.com/a2a/auth-security) from the StackOne dashboard.
3. [Create a StackOne API key](https://docs.stackone.com/guides/api-keys) with the `Actions Execute` scope. You also
   need an API key for the model used by your agent.
