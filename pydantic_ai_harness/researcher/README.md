...
Or skip the file entirely and run the exported `researcher_agent` with [Pydantic AI's CLI](https://pydantic.dev/docs/ai/cli/#custom-agents), via [`uvx`](https://docs.astral.sh/uv/guides/tools/):
